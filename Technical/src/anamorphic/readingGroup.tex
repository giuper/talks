...
\title[Anamorphic]{Anamorphic Encryption: Current Developments}
...
\item Receiver-Privacy: Constructions
    ...
    \end{itemize}
\item Sender-Freedom: Constructions
\end{itemize}

\vfill
\color{brown}
Results from Eurocrypt 2022  paper, {\tt\color{blue}  https://ia.cr/2022/639}
...
\centerline{\em Resistence is futile}
\end{frame}
